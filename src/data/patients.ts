...
export interface DischargeCheck {
  ...
  communication?: {
    medSummary?: boolean;
    medHandoff?: boolean;
    nurseHandoff?: boolean;
    family?: boolean;
    receivingTeam?: boolean;
    rxReviewed?: boolean;
  };
...
export const patients: Patient[] = [
  {
    ...
    devices: [
      {
        ...
        site: "Oral",
        size: "7.5",
        insertedAt: daysAgoISO(10, 14, 20),
        insertedBy: "Dr. Lima",
        notes: "Fixação 22 cm",
      ...
      {
        id: "d2",
        category: "venous_central",
        typeCode: "CVC_SUB",
        site: "Subclávia D",
        lumens: 3,
        insertedAt: daysAgoISO(10, 15, 10),
        insertedBy: "Dr. Lima",
        recommendedMaxDays: 7,
      },
      {
        ...
        site: "Uretral",
        size: "3 vias",
        insertedAt: daysAgoISO(9, 9, 0),
        insertedBy: "Enf. Paula",
    ...
    medications: [
      {
        ...
        active: true,
        category: "vasoativa",
        therapeuticClass: "Vasopressor adrenérgico",
        mlPerHour: 13.0,
        concentrationMgPerMl: 0.08,
        pump: {
          mode: "continua",
          solvent: "SF 0,9%",
          drugAmountMg: 8,
          finalVolumeMl: 100,
          concentrationMcgPerMl: 80,
          targetDoseValue: 0.28,
          targetDoseUnit: "mcg/kg/min",
          rateMlPerHour: 13.0,
          bagVolumeMl: 100,
          bagStartedAt: daysAgoISO(0, -4, 0),
        },
      },
      {
        name: "Meropenem",
        ...
        therapeuticClass: "Carbapenêmico",
        isAntibiotic: true,
      ...
      },
      {
        ...
        pump: {
          ...
          drugAmountMg: 2.5,
          finalVolumeMl: 50,
          concentrationMcgPerMl: 50,
          targetDoseValue: 50,
          targetDoseUnit: "mcg/min",
          rateMlPerHour: 1.0,
          bagVolumeMl: 50,
          bagStartedAt: daysAgoISO(0, -10, 0),
        },
      },
      {
        name: "Midazolam",
    ...
    conducts: [
      {
        team: "Médica",
        text: "Ajustar antibiótico após cultura",
        startedAt: daysAgoISO(0),
        done: false,
      },
      { team: "Médica", text: "Solicitar TC tórax", startedAt: daysAgoISO(1), done: true },
      {
        team: "Médica",
        text: "Iniciar desmame ventilatório",
        startedAt: daysAgoISO(2),
        done: false,
      },
      { team: "Enfermagem", text: "Troca de curativo CVC", startedAt: daysAgoISO(3), done: true },
      { team: "Enfermagem", text: "Controle glicêmico 4/4h", startedAt: daysAgoISO(4), done: true },
      { team: "Fisioterapia", text: "Mobilização passiva", startedAt: daysAgoISO(5), done: false },
      {
        team: "Nutrição",
        text: "Ajuste calórico para 25 kcal/kg",
        startedAt: daysAgoISO(6),
        done: true,
      },
      {
        team: "Fono",
        text: "Avaliação de deglutição pós-extubação",
        startedAt: daysAgoISO(0),
        done: false,
      },
    ],
    ...
    cultures: [
      {
        id: "c1",
        source: "Aspirado traqueal",
        collectedAt: daysAgoISO(6, 7, 30),
        organism: "Pseudomonas aeruginosa",
        resistanceProfile: "MDR",
        sensitivities: ["Meropenem", "Colistina"],
        resistances: ["Ceftazidima", "Cipro"],
        linkedFocusId: "inf1",
      },
      {
        id: "c2",
        source: "Hemocultura periférica",
        collectedAt: daysAgoISO(1, 6, 0),
        resistanceProfile: "pendente",
        linkedFocusId: "inf2",
      },
      {
        id: "c3",
        source: "Hemocultura CVC",
        collectedAt: daysAgoISO(1, 6, 5),
        resistanceProfile: "pendente",
        linkedFocusId: "inf2",
      },
    ],
    infectionTimeline: [
      ...
      {
        at: daysAgoISO(7, 7, 30),
        kind: "cultura_coletada",
        label: "Aspirado traqueal coletado",
        focusId: "inf1",
      },
      {
        at: daysAgoISO(7, 8, 0),
        kind: "atb_inicio",
        label: "Início de Meropenem 1g 8/8h",
        focusId: "inf1",
      },
      {
        at: daysAgoISO(6, 9, 0),
        kind: "cultura_positiva",
        label: "Pseudomonas MDR sensível a Mero",
        focusId: "inf1",
      },
      { at: daysAgoISO(2, 5, 30), kind: "febre", label: "Re-pico febril 38,4°C", focusId: "inf2" },
      {
        at: daysAgoISO(1, 6, 0),
        kind: "cultura_coletada",
        label: "Hemoculturas pareadas (perif+CVC)",
        focusId: "inf2",
      },
    ...
    state: {
      ...
      temp: 38.4,
      dieta: "Enteral plena",
      infection: "Sepse pulmonar",
    },
    lpp: [
      {
        id: "lpp1",
        identifiedAt: daysAgoISO(6, 9, 0),
        professional: "Enf. Paula",
        site: "sacro",
        siteLabel: "Sacro",
        view: "posterior",
        side: "central",
      ...
      {
        id: "lpp2",
        identifiedAt: daysAgoISO(3, 8, 0),
        professional: "Enf. Paula",
        site: "calcaneo_d",
        siteLabel: "Calcâneo direito",
        view: "posterior",
        side: "D",
        count: 1,
        stage: "1",
  ...
  },
  {
    ...
    devices: [
      ...
      },
      {
        ...
        site: "Frontal D",
        side: "D",
        insertedAt: daysAgoISO(4, 2, 30),
        notes: "Altura 15 cmH₂O",
        recommendedMaxDays: 7,
      },
      {
        id: "d8",
      ...
      },
      {
        ...
        category: "venous_central",
        typeCode: "CVC_JUG",
        site: "Jugular interna D",
        lumens: 3,
        insertedAt: daysAgoISO(4, 4, 0),
        recommendedMaxDays: 7,
      },
      {
        id: "d10",
    ...
    conducts: [
      { team: "Médica", text: "Manter PAM 90-100", startedAt: daysAgoISO(1), done: true },
      {
        team: "Médica",
        text: "Doppler transcraniano amanhã",
        startedAt: daysAgoISO(2),
        done: false,
      },
      { team: "Enfermagem", text: "Cabeceira 30°", startedAt: daysAgoISO(3), done: true },
      { team: "Fisioterapia", text: "Higiene brônquica", startedAt: daysAgoISO(4), done: true },
    ],
    goals: [
  ...
  },
  {
    ...
    conducts: [
      { team: "Médica", text: "Programar alta UTI", startedAt: daysAgoISO(5), done: false },
      {
        team: "Fisioterapia",
        text: "Treino muscular respiratório",
        startedAt: daysAgoISO(6),
        done: true,
      },
      { team: "Nutrição", text: "Dieta VO progressiva", startedAt: daysAgoISO(0), done: true },
    ],
    goals: [
      { text: "SatO2 > 92%", met: true },
  ...
  // =========================================================================
  {
    ...
    social: {
      ...
      etilismo: "ex-etilista",
      ocupacao: "Comerciante",
      dependencia: "Independente prévio",
    },
    allergies: ["Sulfa"],
    ...
    procedures: [
      {
        date: "09/08 03:10",
        label: "Laparotomia exploradora com colostomia",
      ...
      {
        date: "16/08 10:30",
        label: "Relaparotomia programada",
        detail: "Lavagem de cavidade",
        kind: "critical",
      },
      {
        date: "22/08 09:00",
        label: "Traqueostomia percutânea",
        detail: "Cânula 8.0 plástica",
        kind: "resp",
      },
    ...
    medications: [
      {
        ...
        pump: {
          ...
          finalVolumeMl: 100,
          concentrationMcgPerMl: 80,
          targetDoseValue: 0.15,
          targetDoseUnit: "mcg/kg/min",
          rateMlPerHour: 8.8,
          bagVolumeMl: 100,
          bagStartedAt: daysAgoISO(0, 2, 0),
        },
      },
      {
        name: "Polimixina B",
        ...
        active: true,
        category: "antimicrobiano",
        therapeuticClass: "Polimixina",
        isAntibiotic: true,
        startISO: daysAgoISO(7, 8, 0),
        plannedEndISO: daysAgoISO(-7, 8, 0),
        plannedDoses: 28,
        dosesGiven: 14,
      },
      {
        ...
        therapeuticClass: "Carbapenêmico",
        isAntibiotic: true,
        startISO: daysAgoISO(15, 8, 0),
        plannedEndISO: daysAgoISO(5, 8, 0),
        plannedDoses: 33,
        dosesGiven: 33,
      },
      {
    ...
    imaging: [
      {
        ...
        modality: "TC",
        region: "Abdome total",
        performedAt: daysAgoISO(15, 9, 0),
        summary: "Coleção em goteira parietocólica esquerda, drenada em relaparotomia.",
        conclusion: "alterado",
        status: "concluido",
      },
      {
        ...
        modality: "RX",
        region: "Tórax",
        performedAt: daysAgoISO(6, 7, 0),
        summary: "Infiltrado alveolar em base direita, menor que exame prévio.",
        conclusion: "alterado",
        status: "concluido",
      },
      {
        ...
        modality: "USG",
        region: "Abdome",
        performedAt: daysAgoISO(2, 10, 0),
        summary: "Sem coleções residuais. Alças de calibre normal.",
        conclusion: "normal",
        status: "concluido",
      },
    ],
    eeg: [
      {
        id: "eeg4",
        performedAt: daysAgoISO(8, 11, 0),
        report:
          "Lentificação difusa moderada, compatível com encefalopatia metabólica/séptica. Sem atividade epileptiforme.",
        reportedBy: "Dra. L. Prado",
      },
    ],
    hemotransfusions: [
      {
        id: "ht4a",
        date: daysAgoISO(18, 15, 0),
        component: "Concentrado de hemácias",
        volume: "2 bolsas · 500 mL",
        note: "Hb 6,9 g/dL com instabilidade.",
      },
      {
        id: "ht4b",
        date: daysAgoISO(11, 13, 0),
        component: "Plasma fresco congelado",
        volume: "3 bolsas",
        note: "INR 2,1 antes de relaparotomia.",
      },
      {
        id: "ht4c",
        date: daysAgoISO(4, 16, 0),
        component: "Concentrado de hemácias",
        volume: "1 bolsa · 250 mL",
        note: "Hb 7,2 g/dL.",
      },
    ],
    infections: [
      {
        ...
        site: "PERITONITE",
        status: "confirmado",
        startedAt: daysAgoISO(22, 3, 0),
        resolvedAt: daysAgoISO(8, 8, 0),
        cultureIds: ["c4a"],
        antimicrobials: ["Meropenem"],
        notes: "Peritonite fecal — controle de foco cirúrgico.",
      },
      {
        id: "inf4b",
        site: "PAV",
        status: "confirmado",
        unstable: true,
        startedAt: daysAgoISO(8, 5, 0),
        relatedDeviceIds: ["d4a"],
        cultureIds: ["c4b"],
        antimicrobials: ["Polimixina B"],
        notes: "Acinetobacter baumannii XDR.",
      },
    ],
    cultures: [
      {
        id: "c4a",
        source: "Líquido peritoneal",
        collectedAt: daysAgoISO(22, 4, 0),
        organism: "Escherichia coli",
        resistanceProfile: "MDR",
        sensitivities: ["Meropenem", "Amicacina"],
      ...
      },
      {
        id: "c4b",
        source: "Aspirado traqueal",
        collectedAt: daysAgoISO(8, 6, 0),
        organism: "Acinetobacter baumannii",
        resistanceProfile: "XDR",
        sensitivities: ["Polimixina B"],
        resistances: ["Meropenem", "Ampicilina-sulbactam"],
        linkedFocusId: "inf4b",
      },
      {
        id: "c4c",
        source: "Hemocultura periférica",
        collectedAt: daysAgoISO(3, 6, 0),
        resistanceProfile: "pendente",
        linkedFocusId: "inf4b",
      },
    ],
    infectionTimeline: [
      {
        at: daysAgoISO(22, 3, 0),
        kind: "atb_inicio",
        label: "Início de esquema empírico amplo",
        focusId: "inf4a",
      },
      {
        at: daysAgoISO(20, 9, 0),
        kind: "cultura_positiva",
        label: "E. coli ESBL em líquido peritoneal",
        focusId: "inf4a",
      },
    ...
    lpp: [
      {
        id: "lpp4",
        identifiedAt: daysAgoISO(14, 9, 0),
        professional: "Enf. Rita",
        site: "sacro",
        siteLabel: "Sacro",
        view: "posterior",
        side: "central",
        ...
        evolutions: [
          {
            ...
            stage: "3",
            professional: "Enf. Rita",
            notes: "Tecido de granulação em bordas.",
          },
          {
            at: daysAgoISO(1, 9, 0),
            stage: "2",
            professional: "Enf. Rita",
            notes: "Redução de profundidade.",
          },
        ],
      },
    ],
    conducts: [
      {
        ...
        subItems: [
          {
            text: "Manter Polimixina B até D14 (07 doses restantes)",
            date: daysAgoISO(1),
            done: false,
          },
          {
            text: "Reavaliar hemoculturas de controle",
            date: daysAgoISO(1),
            done: false,
            color: "orange",
          },
      ...
      },
      {
        ...
        subItems: [
          {
            text: "Desmame em PSV por traqueostomia, tolerando 8 h/dia",
            date: daysAgoISO(2),
            done: true,
          },
      ...
      },
      {
        ...
        subItems: [
          {
            text: "Transição de CRRT para hemodiálise intermitente",
            date: daysAgoISO(3),
            done: true,
          },
          {
            text: "Avaliar retirada de cateter de diálise femoral",
            date: daysAgoISO(3),
            done: false,
            color: "red",
          },
    ...
    state: {
      ...
      pam: 74,
      dva: "Nora 0,15",
      vent: "PSV por traqueostomia",
      fio2: 35,
      diurese: 0.6,
      temp: 37.4,
      dieta: "Enteral plena",
      infection: "PAV por Acinetobacter XDR",
      fr: 22,
      spo2: 95,
      glicemia: 148,
      pas: 116,
      ...
      customSeries: [
        { id: "cs4a", label: "PEEP", unit: "cmH₂O", readings: mkVitals("cs4a", 20, 14, 6, 1, 0) },
        {
          ...
          label: "Diurese",
          unit: "mL",
          readings: mkVitals("cs4b", 20, 180, 1120, 90, 0),
        },
        {
          id: "cs4c",
          label: "Dor (EVA)",
          unit: "0–10",
          readings: mkVitals("cs4c", 20, 6, 2, 1, 0),
        },
        {
          id: "cs4d",
          label: "RASS",
          unit: "-5 a +4",
          readings: mkVitals("cs4d", 20, -4, -1, 0, 0),
        },
      ],
      fluidBalance: {
        intake: [
        ...
        drains: [
          {
            id: "fd4a",
            name: "Dreno tubulolaminar",
            site: "Flanco esquerdo",
            volumeMl: 120,
            aspect: "Serossanguinolento",
            at: daysAgoISO(0, 6, 0),
          },
        ],
        derivations: [
          {
            id: "fv4a",
            name: "Colostomia",
            site: "Fossa ilíaca esquerda",
            volumeMl: 380,
            aspect: "Fecal pastoso",
            at: daysAgoISO(0, 6, 0),
          },
        ],
      },
  ...
  },
  {
    ...
    procedures: [
      ...
      {
        date: "13/08 04:00",
        label: "Primeira sessão de posição prona",
        detail: "16 h",
        kind: "resp",
      },
      ...
      {
        date: "30/08 10:00",
        label: "Teste de respiração espontânea (sucesso parcial)",
        kind: "resp",
      },
    ],
    devices: [
      {
        ...
        site: "Oral",
        size: "7.5",
        insertedAt: daysAgoISO(19, 21, 0),
        recommendedMaxDays: 7,
        notes: "Fixação 21 cm. Indicação de traqueostomia em discussão.",
      },
      {
        id: "d5b",
        category: "venous_central",
      ...
      },
      {
        ...
        category: "drain",
        typeCode: "DRT",
        site: "Hemitórax direito",
        side: "D",
        insertedAt: daysAgoISO(11, 8, 20),
        recommendedMaxDays: 10,
        notes: "Selo d'água, sem escape aéreo há 48 h.",
      },
    ],
    medications: [
      {
      ...
      },
      {
        ...
        active: true,
        category: "antimicrobiano",
        therapeuticClass: "Betalactâmico com inibidor",
        isAntibiotic: true,
        startISO: daysAgoISO(10, 8, 0),
        plannedEndISO: daysAgoISO(-3, 8, 0),
        plannedDoses: 52,
        dosesGiven: 40,
      },
      {
        ...
        active: false,
        category: "outro",
        therapeuticClass: "Bloqueador neuromuscular",
      },
      {
    ...
    imaging: [
      {
        ...
        modality: "TC",
        region: "Tórax",
        performedAt: daysAgoISO(17, 10, 0),
        summary: "Opacidades em vidro fosco difusas com consolidação dependente bilateral.",
        conclusion: "critico",
        status: "concluido",
      },
      {
        ...
        modality: "RX",
        region: "Tórax",
        performedAt: daysAgoISO(11, 9, 0),
        summary: "Pneumotórax à direita, drenado no mesmo dia.",
        conclusion: "critico",
        status: "concluido",
      },
      {
        ...
        modality: "RX",
        region: "Tórax",
        performedAt: daysAgoISO(1, 7, 0),
        summary: "Expansão pulmonar adequada, redução das consolidações.",
        conclusion: "alterado",
        status: "concluido",
      },
      {
        id: "i5d",
        modality: "ECO",
        region: "Ecocardiograma transtorácico",
        performedAt: daysAgoISO(9, 14, 0),
        summary: "FEVE 62%, sem disfunção de VD.",
        conclusion: "normal",
        status: "concluido",
      },
    ],
    eeg: [
      {
        id: "eeg5",
        performedAt: daysAgoISO(5, 10, 0),
        report:
          "Traçado com atividade de base preservada. Sem paroxismos. Compatível com efeito sedativo residual.",
        reportedBy: "Dra. L. Prado",
      },
    ],
    hemotransfusions: [
      {
        id: "ht5a",
        date: daysAgoISO(13, 12, 0),
        component: "Concentrado de hemácias",
        volume: "1 bolsa · 250 mL",
        note: "Hb 7,1 g/dL durante prona.",
      },
    ],
    infections: [
      {
        ...
        site: "PAC",
        status: "resolvido",
        startedAt: daysAgoISO(19, 21, 0),
        resolvedAt: daysAgoISO(9, 8, 0),
        notes: "Influenza A tratada com oseltamivir por 10 dias.",
      },
      {
        id: "inf5b",
        site: "PAV",
        status: "provavel",
        startedAt: daysAgoISO(10, 8, 0),
        relatedDeviceIds: ["d5a"],
        cultureIds: ["c5a"],
        antimicrobials: ["Piperacilina-tazobactam"],
        notes: "Piora de secreção e febre no D9.",
      },
    ],
    cultures: [
      {
        id: "c5a",
        source: "Aspirado traqueal",
        collectedAt: daysAgoISO(10, 7, 0),
        organism: "Klebsiella pneumoniae",
        resistanceProfile: "sensivel",
        sensitivities: ["Piperacilina-tazobactam", "Meropenem"],
        linkedFocusId: "inf5b",
      },
      {
        id: "c5b",
        source: "Hemocultura periférica",
        collectedAt: daysAgoISO(10, 7, 10),
        result: "negativa",
        linkedFocusId: "inf5b",
      },
    ],
    infectionTimeline: [
      {
        at: daysAgoISO(19, 21, 0),
        kind: "atb_inicio",
        label: "Oseltamivir iniciado",
        focusId: "inf5a",
      },
      { at: daysAgoISO(10, 6, 0), kind: "febre", label: "Pico febril 38,5 °C", focusId: "inf5b" },
      {
        at: daysAgoISO(10, 7, 0),
        kind: "cultura_coletada",
        label: "Aspirado traqueal e hemoculturas",
        focusId: "inf5b",
      },
      {
        at: daysAgoISO(8, 9, 0),
        kind: "cultura_positiva",
        label: "Klebsiella sensível",
        focusId: "inf5b",
      },
    ],
    conducts: [
      {
        ...
        subItems: [
          ...
          {
            text: "Definir traqueostomia se falha em 48 h",
            date: daysAgoISO(0),
            done: false,
            color: "orange",
          },
      ...
      },
      {
        ...
        subItems: [
          {
            text: "Completar 14 dias de piperacilina-tazobactam",
            date: daysAgoISO(1),
            done: false,
          },
        ],
      },
      {
        ...
        subItems: [
          {
            text: "Sem escape aéreo há 48 h — clampear e retirar",
            date: daysAgoISO(2),
            done: false,
            color: "teal",
          },
      ...
      },
      {
        ...
        system: "fono",
        subItems: [{ text: "Avaliação após extubação", date: daysAgoISO(4), done: false }],
      },
      {
        team: "Psicologia",
        text: "Suporte",
    ...
    state: {
      ...
      customSeries: [
        ...
        { id: "cs5b", label: "FiO₂", unit: "%", readings: mkVitals("cs5b", 18, 100, 35, 4, 0) },
        {
          ...
          unit: "cmH₂O",
          readings: mkVitals("cs5c", 18, 17, 9, 1, 0),
        },
        {
          id: "cs5d",
          label: "Complacência estática",
          unit: "mL/cmH₂O",
          readings: mkVitals("cs5d", 18, 22, 44, 2, 0),
        },
        {
          id: "cs5e",
          label: "Volume corrente",
          unit: "mL",
          readings: mkVitals("cs5e", 18, 340, 420, 15, 0),
        },
      ],
      fluidBalance: {
        intake: [
  ...
  },
  {
    ...
    diagnoses: [
      ...
      {
        date: "07/08",
        label: "Choque hemorrágico compensado",
        kind: "neutral",
        category: "inactive",
      },
    ...
    procedures: [
      ...
      {
        date: "05/08 05:00",
        label: "Craniotomia descompressiva",
        detail: "Neurocirurgia",
        kind: "neuro",
      },
    ...
    devices: [
      {
        ...
        size: "8.0",
        cannulaType: "plástica",
        insertedAt: daysAgoISO(8, 9, 30),
        lastCannulaChangeAt: daysAgoISO(1, 9, 0),
        recommendedMaxDays: 30,
      },
      {
        id: "d6b",
      ...
      },
      {
        ...
        site: "Uretral",
        size: "2 vias",
        insertedAt: daysAgoISO(3, 8, 0),
        recommendedMaxDays: 14,
      },
      {
        id: "d6d",
        category: "venous_peripheral",
        typeCode: "PVP",
        site: "Antebraço E",
        insertedAt: daysAgoISO(1, 8, 0),
        recommendedMaxDays: 4,
      },
    ],
    medications: [
      {
      ...
      },
      {
        ...
        active: true,
        category: "outro",
        therapeuticClass: "Betabloqueador (disautonomia)",
      },
      {
        name: "Clonidina",
        dose: "0,1 mg",
      ...
      },
      {
        ...
        active: false,
        isAntibiotic: true,
        startISO: daysAgoISO(25, 8, 0),
        plannedEndISO: daysAgoISO(23, 8, 0),
        plannedDoses: 6,
        dosesGiven: 6,
        category: "antimicrobiano",
      },
    ...
    imaging: [
      {
        ...
        modality: "TC",
        region: "Crânio",
        performedAt: daysAgoISO(26, 3, 0),
        summary: "Contusão frontal bilateral com edema difuso e desvio de linha média de 8 mm.",
        conclusion: "critico",
        status: "concluido",
      },
      {
        ...
        modality: "TC",
        region: "Crânio",
        performedAt: daysAgoISO(12, 9, 0),
        summary: "Redução do edema, sem novos focos hemorrágicos.",
        conclusion: "alterado",
        status: "concluido",
      },
      {
        id: "i6c",
        modality: "RX",
        region: "Fêmur direito",
        performedAt: daysAgoISO(20, 11, 0),
        summary: "Material de osteossíntese com bom posicionamento.",
        conclusion: "alterado",
        status: "concluido",
      },
      {
        id: "i6d",
        modality: "TC",
        region: "Crânio (controle)",
        performedAt: daysAgoISO(1, 8, 0),
        summary: "Controle pré-cranioplastia solicitado.",
        conclusion: "pendente",
        status: "solicitado",
      },
    ],
    eeg: [
      {
        id: "eeg6a",
        performedAt: daysAgoISO(21, 10, 0),
        report:
          "Lentificação difusa acentuada com assimetria frontal esquerda. Sem crises eletrográficas.",
        reportedBy: "Dra. L. Prado",
      },
      {
        id: "eeg6b",
        performedAt: daysAgoISO(6, 10, 0),
        report:
          "Melhora da organização do traçado. Reatividade presente a estímulos. Sem atividade epileptiforme.",
        reportedBy: "Dra. L. Prado",
      },
    ],
    hemotransfusions: [
      {
        id: "ht6a",
        date: daysAgoISO(26, 4, 0),
        component: "Concentrado de hemácias",
        volume: "4 bolsas · 1000 mL",
        note: "Protocolo de transfusão maciça na admissão.",
      },
      {
        id: "ht6b",
        date: daysAgoISO(26, 5, 0),
        component: "Plasma fresco congelado",
        volume: "4 bolsas",
      },
    ...
    infections: [
      {
        ...
        site: "ITU",
        status: "resolvido",
        startedAt: daysAgoISO(16, 8, 0),
        resolvedAt: daysAgoISO(9, 8, 0),
        relatedDeviceIds: ["d6c"],
        notes: "Tratada com curso curto, urocultura de controle negativa.",
      },
    ],
    cultures: [
      {
        id: "c6a",
        source: "Urocultura",
        collectedAt: daysAgoISO(16, 7, 0),
        organism: "Escherichia coli",
        resistanceProfile: "sensivel",
        sensitivities: ["Ceftriaxona", "Amicacina"],
        linkedFocusId: "inf6a",
      },
      {
        id: "c6b",
        source: "Urocultura de controle",
        collectedAt: daysAgoISO(8, 7, 0),
        result: "negativa",
        linkedFocusId: "inf6a",
      },
    ],
    lpp: [
      {
        id: "lpp6",
        identifiedAt: daysAgoISO(18, 9, 0),
        professional: "Enf. Rita",
        site: "occipital",
        siteLabel: "Occipital",
        view: "posterior",
        ...
        evolutions: [
          {
            at: daysAgoISO(10, 9, 0),
            stage: "1",
            professional: "Enf. Rita",
            notes: "Sem hiperemia residual.",
          },
        ],
      },
    ],
    conducts: [
      {
        ...
        subItems: [
          ...
          {
            text: "Programar cranioplastia após TC de controle",
            date: daysAgoISO(6),
            done: false,
            color: "teal",
          },
      ...
      {
        team: "Fisioterapia",
        text: "Reabilitação motora",
        startedAt: daysAgoISO(2),
        done: true,
        system: "other",
        subItems: [
          {
            text: "Transferência leito-poltrona com dois profissionais",
            date: daysAgoISO(2),
            done: true,
          },
          {
            text: "Carga parcial em membro inferior direito liberada",
            date: daysAgoISO(2),
            done: true,
          },
        ],
      ...
      {
        team: "Médica",
        text: "Planejamento de alta",
        startedAt: daysAgoISO(4),
        done: false,
        system: "other",
        subItems: [
          {
            text: "Vaga em unidade de reabilitação solicitada",
            date: daysAgoISO(4),
            done: false,
            color: "green",
          },
    ...
    dischargeCheck: {
      ...
      neuro: {
        glasgow: 14,
        pupils: "Isocóricas fotorreagentes",
        deficits: "Hemiparesia esquerda leve",
      },
      diagnosis: {
        dx: "TCE grave em reabilitação",
        procedures: "Craniotomia descompressiva, osteossíntese, traqueostomia",
      },
      ...
      finalization: {
        fit: "nao",
        notes: "Aguardando decanulação e vaga em reabilitação.",
        responsible: "Dr. F. Tavares",
      },
    },
    state: {
      glasgow: 14,
      ...
      pam: 88,
      dva: null,
      vent: "Ar ambiente por traqueostomia",
      fio2: 21,
      diurese: 1.3,
      temp: 36.6,
      ...
      customSeries: [
        ...
        { id: "cs6d", label: "Braden", unit: "6–23", readings: mkVitals("cs6d", 22, 11, 18, 1, 0) },
        {
          ...
          label: "Diurese/kg/h",
          unit: "mL/kg/h",
          readings: mkVitals("cs6e", 22, 0.6, 1.3, 0.1, 1),
        },
      ],
      fluidBalance: {
        intake: [
