...
function Passometro() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      >
        <div className="relative flex min-h-56 items-center justify-center px-20 py-3 sm:px-24">
          {/* Logo stays centered and never overlaps the tools button. */}
          <img
            src={axonLogo}
            alt="Axon Critical Care Intelligence"
            className="block h-auto max-h-40 w-auto max-w-full rounded-md object-contain sm:max-h-52"
            style={{
              filter:
